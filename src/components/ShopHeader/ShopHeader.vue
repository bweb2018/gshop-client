<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click=" briefIsShow = true">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="activityIsShow = true">
    ...
    <div class="shop-brief-modal" v-show="briefIsShow">
      <div class="brief-modal-content">
        ...
        <div class="mask-footer">
          <span class="iconfont icon-close" @click="briefIsShow = false"></span>
        </div>
      </div>
      <div class="brief-modal-cover"></div>
    </div>
    </transition>
    <div class="activity-sheet" v-show="activityIsShow">
      <div class="activity-sheet-content">
        ...
        <div class="activity-sheet-close">
          <span class="iconfont icon-close"  @click="activityIsShow = false"></span>
        </div>
      </div>
